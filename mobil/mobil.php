...
<body>
        ...
        <main class="container">
            <div class="container col-sm-12 px-2 py-5 row mb-2">
                <div class="d-flex justify-content-between align-items-center pb-2 mb-2">
                    <h3>Mobil</h3>
                    <a href="tambah-mobil.php" class="btn btn-primary">Tambah</a>
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td class="text-center"><?= $m['model_mobil']; ?></td>
                                <td class="text-center"><?= $m['nopol_mobil']; ?></td>
                                <td class="text-center"><?= $m['tahun_mobil']; ?></td>
                                <td align="center">
                                    <button class="btn btn-warning" onclick="ubahmobil('<?= $m['id_mobil']; ?>')">
                                        Edit
                                    </button>

                                    <button class="btn btn-danger" onclick="hapusmobil('<?= $m['id_mobil']; ?>')">
                                        Hapus
                                    </button>
                                </td>
                            </tr>
    ...
    <script>
        function hapusmobil(data) {
            if (confirm("Hapus Data Mobil?")) {
                window.location.href = "../hapusdata.php?hapusmobil=" + data;
            } else {}
        }

        function ubahmobil(data) {
            window.location.href = "ubah-mobil.php?id_mobil=" + data;
        }
    </script>
</body>
