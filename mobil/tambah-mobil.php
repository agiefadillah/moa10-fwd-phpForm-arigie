            ...
            <div class="container col-sm-12 px-2 py-5 row mb-2">
                ...
                <div class="container card-body col-sm-12 row">
                    ...
                    <form action="" method="POST">
                        ...
                        <div class="col-sm">
                            <input type="text" class="form-control " placeholder="Masukan Model Mobil" name="model_mobil" required>
                        </div>

                        <h5 class="card-title mt-4">Nomor Polisi</h5>
                        <div class="col-sm">
                            <input type="text" class="form-control " placeholder="Masukan Nomor Polisi Mobil" name="nopol_mobil" required>
                        </div>

                        <h5 class="card-title mt-4">Tahun</h5>
                        <div class="col-sm">
                            <input type="text" class="form-control " placeholder="Masukan Tahun Mobil" name="tahun_mobil" required>
                        </div>
