...
$k = query("SELECT * FROM kustomer WHERE id_kustomer='$id_kustomer'")[0];
            ...
            <div class="container col-sm-12 px-2 py-5 row mb-2">
                ...
                <div class="container card-body col-sm-12 row">
                    ...
                    <form action="" method="POST">
                        <input type="hidden" name="id_kustomer" value="<?= $k['id_kustomer']; ?>">
                        <h5 class="card-title mt-4">Nama</h5>
                        <div class="col-sm">
                            <input type="text" class="form-control " placeholder="Masukan Nama Kustomer" name="nama_kustomer" value="<?= $k['nama_kustomer']; ?>" required>
                        </div>

                        <h5 class="card-title mt-4">Alamat</h5>
                        <div class="col-sm">
                            <input type="text" class="form-control " placeholder="Masukan Alamat Kustomer" name="alamat_kustomer" value="<?= $k['alamat_kustomer']; ?>" required>
                        </div>

                        <h5 class="card-title mt-4">Nomor Telepon</h5>
                        <div class="col-sm">
                            <input type="text" class="form-control " placeholder="Masukan Nomor Telepon Kustomer" name="telp_kustomer" value="<?= $k['telp_kustomer']; ?>" required>
                        </div>
