...
<body>
                    ...
                    <form action="" method="POST">
                        ...
                        <div class="col-sm">
                            <select class="form-select" name="id_kustomer" id="id_kustomer">
                                <option selected disabled>Pilih Kustomer</option>
                                ...
                                ?>
                                    <option value="<?= $k['id_kustomer']; ?>"><?= $k['nama_kustomer']; ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                        ...
                        <div class="col-sm">
                            <select class="form-select" name="id_mobil" id="id_mobil">
                                ...
                                ?>
                                    <option value="<?= $m['id_mobil']; ?>"><?= $m['model_mobil']; ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
    ...
    <script>
        ...
        document.getElementById('tanggal_kembali').min = today.toISOString().split("T")[0];
    </script>
